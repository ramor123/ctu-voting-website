...
urlpatterns = [
    ...
    path('login/', views.login_view, name='votingLogin'),            # <-- login route (matches views.login_view)
    ...
    path('ballot/', views.ballot_page, name='ballot_page'),
    path('confirm/', views.confirmation_page, name='confirmation_page'),
]
